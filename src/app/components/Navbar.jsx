      ...
      <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-1">
          ...
          <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <Link href="/#Contact" className="TH border-2 hover:border-sky-800 text-white font-light bg-customBlue hover:bg-white hover:text-customBlue px-4 py-2 text-center rounded-full">ติดต่อ</Link>
            <button
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li className='TH text-customBlue text-xl'>
                <div className="relative group">
                  <div tabIndex={0} className="mr-14 block py-2 px-3 rounded md:hover:bg-transparent md:hover:text-lightBlue md:p-0 cursor-pointer">
                    ผลงาน
                  </div>
                  <ul className="dropdown-content absolute z-[1] menu p-2 shadow bg-base-100 rounded-box w-64 opacity-0 invisible transition-opacity duration-300 ease-in-out group-hover:opacity-100 group-hover:visible">
