...
const page = () => {
  return (
    <>
      <heading className="mt-3 bg-center bg-no-repeat bg-[url('/bg_program.png')] bg-blend-multiply h-auto">
          <div className="ENG px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
              ...
              <p class="mt-5 font-normal text-lg text-customBlue sm:text-xl md:text-2xl lg:text-3xl">interactive program & mini game for event</p>
          </div>
